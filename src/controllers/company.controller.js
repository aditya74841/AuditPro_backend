...
const createCompany = asyncHandler(async (req, res) => {
  ...
  if (!company) {
    throw new ApiError(
      500,
      "Something went Wrong while creating a new Company"
    );
  }
...
const deleteCompany = asyncHandler(async (req, res) => {
  ...
  if (!deletedcompany) {
    throw new ApiError(500, "Somathing went worng while deleting company");
  }

  return res
    .status(201)
    .json(new ApiResponse(201, deletedcompany, "Company Deleted Successfully"));
});
